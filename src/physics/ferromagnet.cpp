...
Ferromagnet::Ferromagnet(std::shared_ptr<System> system_ptr, 
    ...
    : Magnet(system_ptr, name),
      ...
      ku1_prime(system(), 0.0, name + ":ku1_prime", "J/m3"),
      ...
      pol_zl(system(), 0.0, name + ":pol_zl", ""),
      anisU(system(), {0, 0, 0}, name + ":anisU", ""),
      anisU_prime(system(), {0, 0, 0}, name + ":anisU_prime", ""),
      anisC1(system(), {0, 0, 0}, name + ":anisC1", ""),
      anisC2(system(), {0, 0, 0}, name + ":anisC2", ""),
      jcur(system(), {0, 0, 0}, name + ":jcur", "A/m2"),
      jcur_stt(system(), {0, 0, 0}, name + ":jcur_stt", "A/m2"),
      jcur_zl(system(), {0, 0, 0}, name + ":jcur_zl", "A/m2"),
      ...
      enableCombinedSpinTransferTorque(false),
